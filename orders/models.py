...
("Tifariti","Tifariti"), 
    ...
    artisan=models.ForeignKey(User,related_name='demande_artisan_set',on_delete=models.CASCADE)
    client=models.ForeignKey(User,related_name='demande_client_set',on_delete=models.CASCADE)
